              ...
              <form onSubmit={handleSubmit}>
                <div className="flex gap-2">
                  <input
                    ...
                    className="flex-1 px-4 py-3 rounded-lg bg-white/10 backdrop-blur-md border border-white/20 focus:outline-none focus:border-orange-500 focus:ring-2 focus:ring-orange-500/50 transition-all duration-300 disabled:opacity-50"
                  />
                  <button
                    type="submit"
                    disabled={submitState === "loading"}
                    className="px-6 py-3 bg-orange-500 hover:bg-orange-600 rounded-lg font-semibold transition-all duration-300 flex items-center gap-2 hover:-translate-y-0.5 hover:shadow-lg hover:shadow-orange-500/25 disabled:opacity-50 disabled:cursor-not-allowed"
                  >
                    {submitState === "loading" ? (
