...
export default function AdminLogin() {
  ...
  useEffect(() => {
    ...
    if (params.get("error") === "unauthorized") setUnauthorized(true);
  }, []);
    ...
    <div className="min-h-screen bg-[#0a0a0a] flex items-center justify-center">
      <div className="bg-[#181818] border border-[#2a2a2a] rounded-2xl p-8 w-full max-w-sm text-center">
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-3 py-3 bg-white hover:bg-gray-100 rounded-lg text-gray-900 font-semibold transition-all"
        >
